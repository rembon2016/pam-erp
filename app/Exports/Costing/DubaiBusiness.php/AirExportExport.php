...
class AirExportExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    {
        return JobOrder::with(['detail', 'loadingplan', 'costing'])->where('job_order_type', 'AIREXPORT')->where('status', '!=', 3)->latest()->get();
    }
