...
final class StoreMultipleChartOfAccountRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'accounts.*.account_number' => ['required', 'string', 'max_digits:10'],
            'accounts.*.account_name' => ['required', 'string', 'max:255'],
            'accounts.*.subledger_code' => ['nullable', 'string', 'max:255'],
            'accounts.*.subledger_name' => ['nullable', 'string', 'max:255'],
        ];
    }
