...
final class CalculationService
{
    public function getChargeByBl($id, $bl_number, $type)
    {
        ...
        $contract = AgentContract::where('customer_id', $id)->whereHas('serviceType', function ($query) use ($type, $ship) {
            if ($type == 'or') {
    ...
    public function getChargeImportByLp($id, $loading_id)
    {
        ...
        $contract = AgentContract::where('customer_id', $id)->whereHas('serviceType', function ($query) {
