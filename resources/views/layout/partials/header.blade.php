    ...
    <div class="top-nav-search">
        <form>
            ...
            <button class="btn" type="submit"><img src="{{ asset('/assets-v2/img/icons/search.svg') }}"
                    alt="img"></button>
        </form>
    </div>
    <!-- /Search -->
    ...
    <ul class="nav nav-tabs user-menu">
        ...
        {{-- <li class="nav-item dropdown has-arrow flag-nav">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button">
                <img src="{{ asset('/assets-v2/img/flags/us1.png') }}" alt="flag"><span>English</span>
            </a>
            <div class="dropdown-menu dropdown-menu-end">
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('/assets-v2/img/flags/us.png') }}" alt="flag"><span>English</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('/assets-v2/img/flags/fr.png') }}" alt="flag"><span>French</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('/assets-v2/img/flags/es.png') }}" alt="flag"><span>Spanish</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('/assets-v2/img/flags/de.png') }}" alt="flag"><span>German</span>
                </a>
            </div>
        </li> --}}
        <!-- /Flag -->
                                ...
                                <div class="d-flex">
                                    <span class="avatar avatar-md active">
                                        <img class="avatar-img rounded-circle" alt="avatar-img"
                                            src="{{ asset('/assets-v2/img/profiles/avatar-02.jpg') }}">
                                    </span>
                        ...
                        <li class="notification-message">
                            <a href="{{ url('profile') }}">
                                <div class="d-flex">
                                    <span class="avatar avatar-md active">
                                        <img class="avatar-img rounded-circle" alt="avatar-img"
                                            src="{{ asset('/assets-v2/img/profiles/avatar-10.jpg') }}">
                                    </span>
                                    <div class="media-body">
                            ...
                            <a href="{{ url('profile') }}">
                                <div class="d-flex">
                                    <span class="avatar avatar-md">
                                        <img class="avatar-img rounded-circle" alt="avatar-img"
                                            src="{{ asset('/assets-v2/img/profiles/avatar-13.jpg') }}">
                                    </span>
                                    <div class="media-body">
                        ...
                        <li class="notification-message">
                            <a href="{{ url('profile') }}">
                                <div class="d-flex">
                                    <span class="avatar avatar-md">
                                        <img class="avatar-img rounded-circle" alt="avatar-img"
                                            src="{{ asset('/assets-v2/img/profiles/avatar-05.jpg') }}">
                                    </span>
                                    <div class="media-body">
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0)" class="user-link  nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                        <img src="{{ asset('/assets-v2/img/profiles/avatar-07.jpg') }}" alt="img"
