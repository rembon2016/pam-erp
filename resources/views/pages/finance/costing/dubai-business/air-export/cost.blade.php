...
@section('title', 'Form Air Export Costing')
@push('css')
<style>
td {
...
<x:layout.card.wrapper>
    ...
    <x:layout.card.body>
     <x:form.wrapper id="costing-form" action="{{ $data['action'] }}" method="{{ $data['method'] }}">
        ...
        <input type="hidden" name="type_costing" value="AIREXPORT">
        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs costing-tabs default-costing-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="export-tab" data-bs-toggle="tab" data-bs-target="#export" type="button" role="tab">Air Export Costing</button>
                </li>
...
<script>
 function setChargeMawb(vendorId,vendorName,vendorCode, mawb, vendorType, type = '') {
      ...
      $(".mawb-auto_"+vendorType).each(function () {
            ...
            //ajax disini
           $.ajax({
            url: `/finance/costing/dubai-business/air-export/contractmawb/${vendorId}/${mawb}/${types}`, // Replace with your actual route
