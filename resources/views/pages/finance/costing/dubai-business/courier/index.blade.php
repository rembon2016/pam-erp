                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-start gap-2">
                        ...
                        <div id="kt_ecommerce_report_customer_orders_export_menu"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route('finance.costing.dubai-business.courier.export.csv') }}" class="menu-link px-3" data-kt-ecommerce-export="csv">Export as CSV</a>
                            </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Trucking Courier No</th>
        ...
        return {
            init: function() {
                ...
                (t = document.querySelector("#sea-air_table")) && (t.querySelectorAll(
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('finance.costing.dubai-business.courier.list') }}",
                        columns: [{"data":"DT_RowIndex","name":"DT_RowIndex","orderable":false,"searchable":false},{"data":"job_order_code","name":"job_order_code"},{"data":"courier_no","name":"courier_no"},{"data":"job_order_date","name":"job_order_date"},{"data":"status","name":"status"},{"data":"action","name":"action"}]
