...
@section('body')
    ...
    <x:layout.card.wrapper>
        ...
        <x:layout.card.body>
            ...
            <x:form.cancel-button href="{{ route('finance.costing.dubai-business.courier.index') }}" label="Cancel" />
...
$(document).on('click', '#closed-button', function (e) {
    ...
    const url = "{{ route('finance.costing.dubai-business.courier.status',[$costing?->id, 2]) }}"; // Get the URL from the link
...
$(document).on('click', '#reopen-button', function (e) {
    ...
    const url = "{{ route('finance.costing.dubai-business.courier.status',[$costing?->id, 3]) }}"; // Get the URL from the link
