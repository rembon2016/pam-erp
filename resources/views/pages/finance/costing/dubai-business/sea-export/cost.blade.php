...
@section('title', 'Form Sea Export Costing')
...
<x:layout.card.wrapper>
    ...
    <x:layout.card.body>
     <x:form.wrapper id="costing-form" action="{{ $data['action'] }}" method="{{ $data['method'] }}">
        ...
        <input type="hidden" name="type_costing" value="SEAEXPORT">
        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs costing-tabs default-costing-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="import-tab" data-bs-toggle="tab" data-bs-target="#import" type="button" role="tab">EXPORT COSTING</button>
                </li>
...
function setChargeBl(vendorId,vendorName,vendorCode, bl, vendorType, type, typeIndex = '') {
      ...
      $(`.${typeIndex}`).each(function () {
            ...
            //ajax disini
           $.ajax({
            url: `/finance/costing/dubai-business/sea-export/contractbl/${vendorId}/${bl}/${type}`, // Replace with your actual route
