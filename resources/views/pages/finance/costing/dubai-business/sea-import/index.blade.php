                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-start gap-2">
                        ...
                        <div id="kt_ecommerce_report_customer_orders_export_menu"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route('finance.costing.dubai-business.sea-import.export.csv') }}" class="menu-link px-3" data-kt-ecommerce-export="csv">Export as CSV</a>
                            </div>
        ...
        return {
            init: function() {
                ...
                (t = document.querySelector("#sea-air_table")) && (t.querySelectorAll(
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('finance.costing.dubai-business.sea-import.list') }}",
