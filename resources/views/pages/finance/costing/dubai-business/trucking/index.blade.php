...
@section('title', 'Trucking Costing')
    ...
    <x:layout.card.wrapper>
        <x:layout.card.header>
            ...
            <x:layout.card.toolbar
                exportCsvLink="{{ route('finance.costing.dubai-business.trucking.export.csv') }}"
                withFilter="true"
            />
        </x:layout.card.header>
        <x:layout.card.body>
...
@component('components.layout.table.datatable', [
    'id' => 'cross-air_table',
    'url' => route('finance.costing.dubai-business.trucking.list'), // Sesuaikan route sesuai kebutuhan Anda
    'dynamicParam' => true,
    'columns' => [
        [
            "data" => "DT_RowIndex",
