...
@section('title', 'Credit Note for Non Trade')

@section('body')
    <x:layout.breadcrumb.wrapper module="General Transaction" pageName="Credit Note for Non Trade">
    ...
    <x:layout.card.wrapper>
        <x:layout.card.header>
            <x:layout.card.toolbar
                createDataLink="{{ route('finance.general-transaction.credit-note.create', ['type' => 'non-trade']) }}"
