...
@section('body')
    <x:layout.breadcrumb.wrapper module="General Transaction" pageName="Journal Voucher">
    ...
    <x:layout.card.wrapper>
        <x:layout.card.header>
            <x:layout.card.toolbar
                createDataLink="{{ route('finance.general-transaction.journal-voucher.create') }}"
            ...
            <x:layout.table.wrapper id="creditor-journal-voucher-table">
                <thead>
                    <x:layout.table.row>
                        ...
                        <x:layout.table.heading widthPixel="100" title="Journal Voucher No." />
                        <x:layout.table.heading widthPixel="100" title="Journal Voucher Date" />
                        ...
                        <x:layout.table.heading widthPixel="100" title="Debit" />
                        <x:layout.table.heading widthPixel="100" title="Credit" />
