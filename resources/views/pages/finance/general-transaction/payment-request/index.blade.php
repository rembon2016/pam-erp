@extends('layout.app')
@section('body')
    <x:layout.breadcrumb.wrapper module="General Transaction" pageName="Payment Request">
    ...
    <x:layout.card.wrapper>
        <x:layout.card.header>
            <x:layout.card.toolbar
                createDataLink="{{ route('finance.general-transaction.payment-request.create') }}"
            ...
            <x:layout.table.wrapper id="creditor-journal-voucher-table">
                <thead>
                    <x:layout.table.row>
                        ...
                        <x:layout.table.heading widthPixel="100" title="Payment Request No." />
                        <x:layout.table.heading widthPixel="100" title="Payment Request Date" />
                        <x:layout.table.heading widthPixel="100" title="Cash/Credit Note No." />
                        <x:layout.table.heading widthPixel="100" title="Cash/Credit Note Date" />
                        <x:layout.table.heading widthPixel="100" title="Party Name" />
                        <x:layout.table.heading widthPixel="100" title="Amount in AED" />
                        <x:layout.table.heading widthPixel="100" title="Created By" />
    ...
    <x:layout.modal.filter-modal>
        ...
        <div class="col-12">
            <x:form.select2 label="Journal Voucher No." name="Journal Voucher No." placeholder="Select Journal Voucher No." :model="request()">
