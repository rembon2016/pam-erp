...
@section('body')
    <x:layout.breadcrumb.wrapper module="General Transaction" pageName="{!! $data['page'] !!}">
        ...
        <x:layout.breadcrumb.item pageName="Receipt Voucher Cancellation"
            href="{{ route('finance.general-transaction.receipt-voucher.index', ['type' => 'cancellation']) }}" />
    ...
    <x:form.wrapper action="{{ $data['action'] }}" method="{{ $data['method'] }}">
        <div class="row">
            ...
            <div class='col-md-3'>
                <x:form.input type="file" label="Upload" name="charge_name" placeholder="Upload" required="true" />
            </div>
            <div class='col-md-3'>
            ...
            <div class='col-md-3'>
                <x:form.input label="Bank" name="charge_name" placeholder="Bank" required="true" />
            </div>
            <div class='col-md-3'>
                <x:form.input label="Branch" name="charge_name" placeholder="Branch" required="true" />
            </div>
            <div class='col-md-3'>
                <x:form.input label="Cheque No." name="charge_name" placeholder="Cheque No." required="true" />
            </div>
            <div class='col-md-3'>
