...
@section('title', 'Receipt Voucher Cancellation')

@section('body')
    <x:layout.breadcrumb.wrapper module="General Transaction" pageName="Receipt Voucher Cancellation">
    ...
    <x:layout.card.wrapper>
        <x:layout.card.header>
            <x:layout.card.toolbar
                createDataLink="{{ route('finance.general-transaction.receipt-voucher.create', ['type' => 'cancellation']) }}"
            ...
            <x:layout.table.wrapper id="creditor-journal-voucher-table">
                <thead>
                    <x:layout.table.row>
                        ...
                        <x:layout.table.heading widthPixel="100" title="Receipt Voucher No." />
                        <x:layout.table.heading widthPixel="100" title="Receipt Voucher Date" />
                        ...
                        <x:layout.table.heading widthPixel="100" title="Debit Note No." />
                        <x:layout.table.heading widthPixel="100" title="Debit Note Date" />
    ...
    <x:layout.modal.filter-modal>
        ...
        <div class="col-12">
            <x:form.select2 label="Receipt Voucher No." name="Receipt Voucher No." placeholder="Select Receipt Voucher No." :model="request()">
