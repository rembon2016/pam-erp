            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-start gap-2">
                        ...
                        <!--end::Filter menu-->
                        <a href="{{ route('finance.master-data.currency.create') }}" class="btn btn-sm custom-btn custom-btn-primary">
                        ...
                        <div id="kt_ecommerce_report_customer_orders_export_menu"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route('finance.master-data.currency.export.excel') }}" class="menu-link px-3" data-kt-ecommerce-export="excel">Export as Excel</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ route('finance.master-data.currency.export.csv') }}" class="menu-link px-3" data-kt-ecommerce-export="csv">Export as CSV</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
