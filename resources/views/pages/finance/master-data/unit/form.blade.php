    ...
    <x:form.wrapper action="{{ $data['action'] }}" method="{{ $data['method'] }}">
        <div class="row">
            <div class='col-md-6 mb-10'>
                <x:form.input label="Unit Code" name="unit_code" placeholder="Type Code of Unit" :model="$unit" required="true" />
            </div>
            <div class='col-md-6 mb-10'>
                <x:form.input label="Unit Name" name="unit_name" placeholder="Type Name of Unit" :model="$unit" required="true" />
            </div>
        </div>
