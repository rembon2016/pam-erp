    ...
    <div class="d-flex justify-content-end mb-3">
        <div class="list-btn">
            <ul class="filter-list">
                ...
                <li>
                    <a class="btn btn-primary" href="{{ route('settings.role-permission.create') }}">
                        <i class="fa fa-plus-circle me-2" aria-hidden="true"></i> Add Role & Permission
                    </a>
                </li>
            ...
            <div class="card-table">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-center table-hover" id="role_table">
