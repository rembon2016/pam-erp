    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush">
                <div class="card-body">
                    <form action="{{ route('settings.shipment-list.global.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="mb-10">
                                        ...
                                        <div class="d-flex mt-2">
                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5">
                                                <input class="form-check-input status" name="status[]" type="checkbox"
                                                    value="{{ $item->status_id }}" @checked(in_array($item->status_id, $setting->pluck('related_id')->toArray()))>
