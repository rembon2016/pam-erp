                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <a href="{{ route('settings.shipment-list.create') }}" class="btn btn-sm btn-light-primary">
                        ...
                        <!--end::Svg Icon-->Add New User Setting</a>
    ...
    return {
        init: function() {
            ...
            (t = document.querySelector("#role_table")) && (t.querySelectorAll(
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('settings.shipment-list.list') }}",
                    columns: [
                        {
                            "data":"DT_RowIndex",
                            "name":"DT_RowIndex",
